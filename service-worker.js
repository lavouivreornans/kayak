...
self.addEventListener("fetch", (event) => {
  ...
  // hors-ligne. "cache: no-store" est indispensable ici : sans ça, le cache
  // HTTP normal du navigateur peut resservir une réponse récente (GitHub
  // Pages envoie Cache-Control: max-age=600) même quand on lui demande le
  // réseau, ce qui retarderait la prise en compte d'une mise à jour.
  event.respondWith(

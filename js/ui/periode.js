...
export function renderPeriodeSelector(container, etat, onChange) {
  ...
  // "input" (et pas seulement "change") pour que la sélection d'une date
  // dans le picker natif se répercute tout de suite, sans attendre que le
  // champ perde le focus — certains navigateurs/webviews ne déclenchent
  // "change" qu'à ce moment-là, ce qui donnait l'impression que le filtre
  // "ne marchait pas".
  inputDebut.addEventListener("input", (e) => {
